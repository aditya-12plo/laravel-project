...
<header class="main-header">
 ...
 @if (Auth::guard('admins'))
  <!-- Logo -->
    <a href="{{ url('/admin/beranda') }}" class="logo">
        ...
        <span class="logo-mini"><b>FGD</b></span>
 ...
 @elseif (Auth::user())
 <!-- Logo -->
    <a href="{{ url('/team/beranda') }}" class="logo">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><b>FGD</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>
                ...
                @if (Auth::guard('admins'))
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="{{ asset('/Uploads/Fusers/'.Auth::guard('admins')->user()->foto)}}" class="user-image" alt="User Image"/>
                            <!-- hidden-xs hides the username on small devices so only the image appears. -->
                            <span class="hidden-xs">{{ Auth::guard('admins')->user()->nama }}</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- The user image in the menu -->
                            <li class="user-header">
                                <img src="{{URL::asset('/Uploads/Fusers/'.Auth::guard('admins')->user()->foto)}}" class="img-circle" alt="User Image" />
                                <p>{{ Auth::guard('admins')->user()->nama }}</p>
                            </li>
                            <!-- Menu Footer-->
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ url('/admin/settings') }}" class="btn btn-default btn-flat">PROFIL</a>
                                </div>
